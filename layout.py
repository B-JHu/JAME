...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.document_status_label = QtWidgets.QLabel(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.document_status_label.sizePolicy().hasHeightForWidth())
        self.document_status_label.setSizePolicy(sizePolicy)
        self.document_status_label.setObjectName("document_status_label")
        self.gridLayout.addWidget(self.document_status_label, 1, 0, 1, 1)
        self.JAME_name_label = QtWidgets.QLabel(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.JAME_name_label.sizePolicy().hasHeightForWidth())
        self.JAME_name_label.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Monospace")
        self.JAME_name_label.setFont(font)
        self.JAME_name_label.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.JAME_name_label.setObjectName("JAME_name_label")
        self.gridLayout.addWidget(self.JAME_name_label, 1, 1, 1, 1)
        ...
        self.actionGitHub_open_repo = QtWidgets.QAction(mainWindow)
        self.actionGitHub_open_repo.setObjectName("actionGitHub_open_repo")
        ...
        self.menuHelp.addAction(self.actionGitHub_open_repo)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.document_status_label.setText(_translate("mainWindow", "0 words (with 0 characters) spanning 0 lines."))
        self.JAME_name_label.setText(_translate("mainWindow", "JAME — Just another Markdown editor"))
        ...
        self.menuInsert.setTitle(_translate("mainWindow", "Format"))
        ...
        self.actionGitHub_open_repo.setText(_translate("mainWindow", "GitHub"))
        self.actionGitHub_open_repo.setToolTip(_translate("mainWindow", "View the GitHub repository of this project"))
        ...
        self.actionLight_mode.setToolTip(_translate("mainWindow", "Why would you do this to yourself?"))
