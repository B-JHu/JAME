...
LINE = r'[^\u000A\u000D]*' + LINE_ENDING
BLANK_LINE = r'^(\u0020|\u0009)*$'
UNICODE_WHITESPACE_CHARS = r'\u0020\u00A0\u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200A\u202F\u205F\u3000\u0009\u000A\u000C\u000D'
UNICODE_WHITESPACE = r'[' + UNICODE_WHITESPACE_CHARS + ']+'
TAB = r'\u0009'
SPACE = r'\u0020'
ASCII_CONTROL_CHARS = r'\u0000\u0001\u0002\u0003\u0004\u0005\u0006\u0007\u0008\u0009\u000A\u000B\u000C\u000D\u000E\u000F\u0010\u0011\u0012\u0013\u0014\u0015\u0016\u0017\u0018\u0019\u001A\u001B\u001C\u001D\u001E\u001F\u007F'
ASCII_PUNCTUATION_CHARS = r'\u002D\!\"\#\$\%\&\'\(\)\*\+\,\-\.\/\u0021\u0022\u0023\u0024\u0025\u0026\u0027\u0028\u0029\u002A\u002B\u002C\u002E\u002F\:\;\<\=\>\?\@\u003A\u003B\u003C\u003D\u003E\u003F\u0040\[\\\]\^\_\`\u005B\u005C\u005D\u005E\u005F\u0060\{\|\}\~\u007B\u007C\u007D\u007E'
...
# sec. 4: Leaf blocks
THEMATIC_BREAK = r'^' + SPACE + '{0,3}((\-[' + SPACE + TAB + ']*){3,}|(\_[' + SPACE + TAB + ']*){3,}|(\*[' + SPACE + TAB + ']*){3,})' + LINE_ENDING
ATX_HEADING = r'^' + SPACE + '{0,3}\#{1,6}([' + SPACE + TAB + ']+|' + LINE_ENDING + ')'
ATX_HEADING_OPT_CLOSING_SEQ = '[' + SPACE + TAB + ']+\#+[' + SPACE + TAB + ']*'
...
LINK_DESTINATION = r'(<[^\n\<\>]*>|[^\<' + ASCII_CONTROL_CHARS + SPACE + r'\)][^' + ASCII_CONTROL_CHARS + SPACE + r'\)]+)' # TODO: link destinations may include non-backslash-escaped closing parentheses if they are a pair of matching parentheses

LINK_TITLE = r'(\"[^\"]*\"|\'[^\']\'|\([^\(\)]\))'  # TODO: fix this so that "hi \" there" becomes a legitimate link title (backslash escaped quotation marks will currently not match this expression
LINK_REFERENCE_DEF = '^' + SPACE + '{0,3}' + LINK_LABEL + '\:[' + SPACE + TAB + ']*' + LINE_ENDING + '?' + LINK_DESTINATION + '[' + SPACE + TAB + ']*' + LINE_ENDING + '?([' + SPACE + TAB + ']+' + LINK_TITLE + ')?'

# sec. 5: Container blocks
BLOCK_QUOTE_MARKER = r'^' + SPACE + '{0,3}\>' + SPACE + '?'

BULLET_LIST_MARKER = r'^[ ]{0,3}(\-|\+|\*)\s+'
ORDERED_LIST_MARKER = r'^[ ]{0,3}\d{1,9}(\.|\))\s+'
...
SCHEME = r'[A-Za-z][A-Za-z\d\+\.\-]{1,31}'
ABS_URI = SCHEME + r'\:[^' + ASCII_CONTROL_CHARS + SPACE + r'\<\>]*'
URI_AUTOLINK = r'\<' + ABS_URI + r'\>'

EMAIL_ADDRESS = r"[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*"
